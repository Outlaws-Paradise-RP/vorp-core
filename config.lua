...
Config = {
    ...
    UIPosition               = 'TopMiddle', -- Changes position of UI. Options: BottomRight, MiddleRight, TopRight, TopMiddle, BottomMiddle
    ...
    biglogodesc              = "Outlaws Paradise RP Connect:",  -- text when hover over image
    ...
    discordlink              = "https://discord.gg/tfprHTkfbN",     -- discord link
